    ...
    <nav class="bg-[#f6f3f5] sticky top-0 z-50 px-6 py-3 flex justify-between items-center">
      ...
      <div class="flex items-center gap-4">
        ...
        <button
          v-if="!user"
          @click="login"
          class="bg-pink-500 text-white px-4 py-2 rounded-lg hover:scale-105 hover:bg-pink-600 transition">
          Iniciar sesión
        </button>
    ...
    <div class="flex h-[calc(100vh-64px)]">
      ...
      <main class="flex-1 lg:ml-64 grid xl:grid-cols-12 gap-8 overflow-hidden p-6">
        ...
        <div class="xl:col-span-4 h-full flex items-start">
          <div class="bg-secondary text-white p-6 rounded-xl w-full sticky top-6">
